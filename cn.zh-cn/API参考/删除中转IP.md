# 删除中转IP<a name="DeleteTransitIp"></a>
...
<tbody><tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.1 "><p>transit_ip_id</p>
</td>
...
<td class="cellrowborder" valign="top" width="85%" headers="mcps1.1.3.1.2 "><p>删除中转IP成功。</p>
</td>
</tr>
</tbody>
</table>
