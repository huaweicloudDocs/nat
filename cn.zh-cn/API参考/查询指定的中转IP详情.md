# 查询指定的中转IP详情<a name="ShowTransitIp"></a>
...
<a name="response_ShowTransitIpResponseBody"></a>
...
<td class="cellrowborder" valign="top" width="85%" headers="mcps1.1.3.1.2 "><p>查询指定中转IP成功。</p>
</td>
</tr>
</tbody>
</table>
