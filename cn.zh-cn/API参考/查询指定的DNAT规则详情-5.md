# 查询指定的DNAT规则详情<a name="ShowPrivateDnat"></a>
...
<tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.1 "><p>dnat_rule_id</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.2 "><p>是</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.3 "><p>String</p>
...
<a name="response_ShowPrivateDnatResponseBody"></a>
...
<td class="cellrowborder" valign="top" width="85%" headers="mcps1.1.3.1.2 "><p>查询DNAT规则成功。</p>
</td>
</tr>
</tbody>
</table>
